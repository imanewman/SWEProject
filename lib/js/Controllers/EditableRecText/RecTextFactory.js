...
var _EditableRecText = _interopRequireDefault(require("./EditableRecText.js"));
...
class RecTextFactory {
  static createTitleText(recModal) {
    ...
    return new _EditableRecText.default(recModal, "#" + recModal.getRecId() + " .rec_item_title h3", 50, title => {
      rec.setTitle(title);
    }, () => {
      return rec.getTitle();
    });
  ...
  static createDateText(recModal) {
    let rec = recModal.getRec();
    return new _EditableRecText.default(recModal, "#" + recModal.getRecId() + " .rec_item_time h5", 60, date => {
      rec.setDateString(date);
    }, () => {
  ...
  static createLocationText(recModal) {
    let rec = recModal.getRec();
    return new _EditableRecText.default(recModal, "#" + recModal.getRecId() + " .rec_item_location h5", 50, loc => {
      rec.setLocation(loc);
    }, () => {
  ...
  static createDescriptionText(recModal) {
    let rec = recModal.getRec();
    return new _EditableRecText.default(recModal, "#" + recModal.getRecId() + " .rec_item_details_description p", 500, desc => {
  ...
  static createRulesText(recModal) {
    let rec = recModal.getRec();
    return new _EditableRecText.default(recModal, "#" + recModal.getRecId() + " .rec_item_details_rules p", 500, rules => {
      rec.setRules(rules);
    }, () => {
      return rec.getRules();
    });
  ...
  static createContactInfoText(recModal) {
    let rec = recModal.getRec();
    return new _EditableRecText.default(recModal, "#" + recModal.getRecId() + " .rec_item_details_contact p", 500, info => {
      rec.setContactInfo(info);
    }, () => {
  ...
  static createWebsiteLinkText(recModal) {
    let rec = recModal.getRec();
    return new _EditableRecText.default(recModal, "#" + recModal.getRecId() + " .rec_item_details_website a", 150, link => {
      rec.setWebsiteLink(link);
    }, () => {
