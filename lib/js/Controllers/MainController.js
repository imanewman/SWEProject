...
var _DatabaseRetriever = _interopRequireDefault(require("../Database/DatabaseRetriever.js"));
...
const Main = new MainController(); // console.log(DatabaseRetriever.getRec('00000001'));
