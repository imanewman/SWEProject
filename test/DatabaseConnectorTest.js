...
describe("Database Connector Tests", () => {
    ...
    describe("Test 'get' function", () => {
        it("gets a Rec from database", (done) => {
            ...
            const expected = [
                {
                    Description: "The Downtown SLO Farmers Market is undoubtedly one of the most treasured events on the Central Coast and has a long history of bringing locals and visitors together to eat, shop, listen to music and connect with their community.\nThe Market takes place every Thursday evening from 6:00 PM to 9:00 PM (weather permitting and excluding major holidays) on Higuera Street between Nipomo and Osos streets.",
